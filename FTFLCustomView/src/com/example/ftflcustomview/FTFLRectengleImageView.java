...
public class FTFLRectengleImageView extends ImageView {
	...
	public FTFLRectengleImageView(Context context, int eWidth, int eHeight) {
		super(context);
	 ...
	 public FTFLRectengleImageView(Context context, AttributeSet attrs) {
	        super(context, attrs);
	       // init();
	    }
